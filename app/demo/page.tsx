                ...
                <div className="max-w-screen-2xl mx-auto flex flex-col items-center">
                    ...
                    <div className="w-full max-w-7xl mx-auto transition-all duration-700 animate-zoom-in delay-300">
                        <div className="relative group">
                            ...
                            <div className="relative rounded-md overflow-hidden border border-foreground/[0.08] shadow-[0_48px_100px_-24px_rgba(0,0,0,0.15),0_0_0_1px_rgba(255,255,255,0.8)] group-hover:shadow-[0_64px_120px_-32px_rgba(47,39,206,0.2),0_0_0_1px_rgba(255,255,255,0.9)] transition-all duration-700">
