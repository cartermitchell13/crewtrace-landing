...
export const staticSeoPolicies: SeoRoutePolicy[] = [
    ...
    },
    {
        ...
        pageKind: "company",
        indexable: true,
        titlePattern: "About Crewtrace | Stop Payroll Leakage for Field Crews",
        descriptionPattern: "Founder story and mission behind Crewtrace — GPS time tracking software built to verify crew hours, reduce payroll leakage, and replace paper timesheets.",
        changeFrequency: "monthly",
        priority: 0.7,
    },
    {
